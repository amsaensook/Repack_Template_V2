    ...
    <>
      <Routes>
        <Route
          index
          element={
            <Navigate to={`${process.env.REACT_APP_PUBLIC_URL}/`} replace />
          }
        />
        <Route
          //index
          ...
          element={
            authResult?.status ? (
              <Navigate
                to={`${process.env.REACT_APP_PUBLIC_URL}/Main`}
                replace
              />
            ) : (
              <Login />
        ...
        />
        <Route
          path={`${process.env.REACT_APP_PUBLIC_URL}/Main`}
          element={
            <ProtectedRoute>
              <Main />
            </ProtectedRoute>
        ...
        <Route path={`${process.env.REACT_APP_PUBLIC_URL}/QrCodePrint`} element={<QrCodePrint/>} />
        <Route path={`${process.env.REACT_APP_PUBLIC_URL}/QrCodePrintAll`} element={<QrCodePrintAll/>} /> 
        <Route path={`${process.env.REACT_APP_PUBLIC_URL}/QrBoxPrintAll`} element={<QrBoxPrintAll/>} />
        <Route path={`${process.env.REACT_APP_PUBLIC_URL}/QrCodePrintMisc`} element={<QrCodePrintMisc/>} /> 
        ...
        {authResult?.data?.permission
          ...
          ?.map((value: any, index: any) => (
            <Route
              key={index}
              path={`${process.env.REACT_APP_PUBLIC_URL}${value.Part}${
                value.IsParent ? "/*" : ""
              }`}
              element={
                <ProtectedRoute>
