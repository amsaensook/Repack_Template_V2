...
const CountStock: React.FC<any> = ({ MenuId, Menu_Index }) => {
  ...
  const [SearchStockCountStatus, setStockCountStatus] = useState(0);

  const [buttonRefresh, setButtonRefresh] = useState(true);

  const {
    isLoading: createIsLoadingCountStockItem,
    isError: createIsErrorCountStockItem,
    data: CountStockItem,
  ...
  const {
    isLoading: createIsLoadingCountStockSnap,
    isError: createIsErrorCountStockSnap,
    data: CountStockSnap,
    error: createErrorCountStockSnap,
  ...
  const {
    isLoading: createIsLoadingCountStock,
    isError: createIsErrorCountStock,
  ...
  const {
    isLoading: updateIsLoadingCountStock,
    isError: updateIsErrorCountStock,
  ...
  const {
    isLoading: CountStockNoIsLoading,
    isError: CountStockNoIsError,
    data: CountStockNo,
  ...
  const {
    isLoading: CountStockStatusIsLoading,
    isError: CountStockStatusIsError,
    data: CountStockStatus,
    status: CountStockStatusStatus,
    error: CountStockStatusError,
    mutate: getCountStockStatus,
  } = useCountStockStatus();

  const {
    isLoading: CountStockStatusIsLoading1,
    isError: CountStockStatusIsError1,
    data: CountStockStatus1,
    status: CountStockStatusStatus1,
    error: CountStockStatusError1,
    mutate: getCountStockStatus1,
  } = useCountStockStatus();

  const {
    isLoading: typeIsLoadingFG,
    isFetching: typeIsFetchingFG,
    isError: typeIsErrorFG,
    data: GradeItem,
    status: typeStatusFG,
    error: typeErrorFG,
  } = useGrade();
  ...
  const {
    isLoading: ProductTypeIsLoading,
    isFetching: ProductTypeIsFetching,
    isError: ProductTypeIsError,
    data: ProductType,
  ...
  useEffect(() => {
    ...
    if (CountStockStatusStatus === "success") {
      setStockCountStatus(CountStockStatus?.data.data[0].Status || 0);
  ...
  useEffect(() => {
    ...
    if (CountStockStatusStatus1 === "success") {
      setStockCountStatus(CountStockStatus1?.data.data[0].Status || 0);
