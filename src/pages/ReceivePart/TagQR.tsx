...
const FormTag: React.FC<any> = ({ visible, handleCloseModelTag, tag }) => {
  ...
  const {
    isLoading: RCStatusIsLoading,
    isError: RCStatusIsError,
    data: RCStatus,
  ...
  const {
    isLoading: RCStatusIsLoading1,
    isError: RCStatusIsError1,
    data: RCStatus1,
  ...
  const {
    isLoading: createIsLoadingReceivePartItem,
    isError: createIsErrorReceivePartItem,
  ...
  const {
    isLoading: ReceiveAutoIsLoading,
    isError: ReceiveAutoIsError,
            ...
            <>
              <button
                onClick={() => {
                  ...
                  window.open(
                    `${process.env.REACT_APP_PUBLIC_URL}${"/QrCodePrint"}`
                  );
                }}
              >
                <PrinterOutlined />
                ...
                <Col span={2}>
                  <Form.Item label=" ">
                    <Button
                      ...
                      onClick={() => {
                        localStorage.setItem("qr", JSON.stringify(dataSource));
