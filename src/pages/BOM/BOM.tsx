...
const BOM: React.FC<any> = () => {
  ...
  const {
    isLoading: createIsLoadingBomItem,
    isError: createIsErrorBomItem,
    data: BomItem,
    error: createErrorBomItem,
  ...
  const {
    isLoading: createIsLoadingBom,
    isError: createIsErrorBom,
    error: createErrorBom,
