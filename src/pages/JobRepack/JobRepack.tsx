...
const JobRepack: React.FC<any> = ({ MenuId, Menu_Index }) => {
  ...
  const {
    isLoading: createIsLoadingJobRepackItem,
    isError: createIsErrorJobRepackItem,
    data: JobRepackItem,
  ...
  const {
    isLoading: createIsLoadingJobRepack,
    isError: createIsErrorJobRepack,
  ...
  const {
    isLoading: updateIsLoadingJobRepack,
    isError: updateIsErrorJobRepack,
  ...
  const {
    ...
    isFetching: JobtypeIsFetching,
    isError: JobtypeIsError,
    data: JobType,
  ...
  const {
    isLoading: GradePlanIsLoading,
    isError: GradePlanIsError,
    data: GradePlan,
  ...
  const {
    isLoading: typeIsLoadingSP,
    isFetching: typeIsFetchingSP,
    isError: typeIsErrorSP,
    data: GradeSP,
    status: typeStatusSP,
    error: typeErrorSP,
  } = useGradeSP();
  ...
  const {
    isLoading: BomForJobIsLoading,
    isFetching: BomForJobIsFetching,
    isError: BomForJobIsError,
    data: BomForJob,
    status: BomForJobStatus,
    error: BomForJobError,
  } = useBomForJob();

  const {
    isLoading: BomRevIsLoading,
    isError: BomRevIsError,
    data: BomRev,
    status: BomRevStatus,
    error: BomRevError,
    mutate: getBomRev,
  ...
  const {
    isLoading: BomItemIsLoading,
    isError: BomItemIsError,
    data: BomItem,
