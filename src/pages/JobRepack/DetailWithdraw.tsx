...
const FormDetail: React.FC<any> = ({ visible, handleCloseDrawer, tag }) => {
  ...
  const {
    isLoading: selectQRBoxIsLoading,
    isError: selectQRBoxIsError,
    data: selectQRBoxDate,
    error: selectQRBoxError,
    status: selectQRBoxStatus,
    mutate: selectQRBox,
  } = useSelectQRBox();

  const {
    isLoading: selectWithdrawItemIsLoading,
    isError: selectWithdrawItemIsError,
    data: selectWithdrawItemData,
    error: selectWithdrawItemError,
