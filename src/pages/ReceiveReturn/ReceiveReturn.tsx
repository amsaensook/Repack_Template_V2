...
const ReceiveReturn: React.FC<any> = ({ MenuId, Menu_Index }) => {
  ...
  const {
    isLoading: createIsLoadingReceiveReturnItem,
    isError: createIsErrorReceiveReturnItem,
  ...
  const {
    isLoading: createIsLoadingReceiveReturn,
    isError: createIsErrorReceiveReturn,
  ...
  const {
    isLoading: updateIsLoadingReceiveReturn,
    isError: updateIsErrorReceiveReturn,
