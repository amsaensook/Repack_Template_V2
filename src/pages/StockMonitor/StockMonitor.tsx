...
const StoreMonitor: React.FC<any> = ({ MenuId, Menu_Index }) => {
  ...
  const {
    isLoading: createIsLoadingStockGroup,
    isError: createIsErrorStockGroup,
    data: StockGroup,
    error: createErrorStockGroup,
    status: getStatusStockGroup,
    mutate: getStockGroup,
  } = useStockGroup();

  const {
    isLoading: createIsLoadingStockDetail,
    isError: createIsErrorStockDetail,
    data: StockDetail,
    error: createErrorStockDetail,
    status: getStatusStockDetail,
    mutate: getStockDetail,
  } = useStockDetail();

  const {
    isLoading: createIsLoadingStockWH,
    isError: createIsErrorStockWH,
    data: StockWH,
    error: createErrorStockWH,
    status: getStatusStockWH,
    mutate: getStockWH,
  } = useStockWH();

  const {
    isLoading: createIsLoadingStockWHHeader,
    isError: createIsErrorStockWHHeader,
    data: StockWHHeader,
    error: createErrorStockWHHeader,
